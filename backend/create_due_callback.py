...
def create_due_callback():
    print('=== CREATING DUE CALLBACK ===')
    ...
    # Create a callback that's due in 5 minutes
    ...
    callback = Callback.objects.create(
        ...
        status='scheduled',
        notes='Test callback due in 5 minutes for alert testing'
    )
    ...
    overdue_time = timezone.now() - timedelta(minutes=10)
